...
module flex_cuts(){
	translate([0,-Box_Y_Width/4,-bh/2]) color("blue") cube([flex_cut_width,Box_Y_Width/2+5,Base_Height+2],center=true);
	rotate([0,0,150]) translate([0,-Box_Y_Width/5,-bh/2]) color("red")  cube([flex_cut_width,Box_Y_Width/4,Base_Height+2],center=true);
	rotate([0,0,-90]) translate([0,-Box_Y_Width/6,-bh/2]) color("green")  cube([flex_cut_width,Box_Y_Width/6,Base_Height+2],center=true);
}
