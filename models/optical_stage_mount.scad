...
module tbs_with_arm() {
	union() {
		...
		difference() {
			translate([37,0,-9.41]) cube([35.5,45,11.176],center=true); //This is the extra appendage sticking out. 
...
rotate([90,0,0]) translate([-32,-15,17.5]) joint();
rotate([90,0,0]) translate([58,-15,17.5]) joint();
translate([3.6,0,0]) tbs_with_arm();

//translate([-24.5,-25,-5]) cube([90,2,2]);