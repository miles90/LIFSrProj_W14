...
module flex_cuts(){
	translate([0,-Box_Y_Width/4,-bh/2]) color("blue") cube([1,Box_Y_Width/2+5,Base_Height+2],center=true);
	rotate([0,0,180]) translate([0,-Box_Y_Width/4,-bh/2]) color("red") cube([1,Box_Y_Width/2+5,Base_Height+2],center=true);
	rotate([0,0,-90]) translate([0,-Box_Y_Width/6,-bh/2]) color("green")  cube([1,Box_Y_Width/6,Base_Height+2],center=true);
}
